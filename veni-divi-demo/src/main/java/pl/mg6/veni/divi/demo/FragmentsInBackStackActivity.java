...
public class FragmentsInBackStackActivity extends Activity {
    ...
    private Fragment getFragment(CharSequence element) {
        Fragment f = null;
        if ("Red".contentEquals(element) || "Green".contentEquals(element)
                || "Blue".contentEquals(element) || "Yellow".contentEquals(element)) {
